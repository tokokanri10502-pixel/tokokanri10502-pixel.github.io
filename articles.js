  ...
  categories: [
    ...
    },
    {
      ...
      articles: [
        {
          icon: "🛒",
          image: "images/ai-agent-brand.png",
      ...
      articles: [
        {
          ...
          url: "https://tokokanri10502-pixel.github.io/hisho-keizai-tokushu.html",
          desc: "2025年夏、日経が紙面で「避暑経済」という言葉を使い始めた。同年6月後半の映画館消費額は前年比+51.9%（JCB消費NOW）、2024年夏に集客が増えた屋内型レジャー施設は72.2%・屋外型は29.4%（三菱UFJリサーチ／東海3県）──暑さが消費を屋内へ押し戻した。2026年、気象庁は40度以上を「酷暑日」と命名。夏物展開は最大1か月前倒され、イオンは涼み場を全国5000カ所開放し、ワークマンは45度対応衣類、花王は累計1,000万個の冷タオルを投入する。「避暑経済」の現在地を、マーケ視点の3軸で整理する。",
          date: "2026.05.15",
          tag: "study",
          tagLabel: "※画像はイメージです"
        },
